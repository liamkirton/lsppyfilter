...
def http_response_filter(pid, tid, sid, header, content):
	...
	content = content.replace('elite', 'l33t')
	content = content.replace('the', 'teh')
	content = content.replace('own', 'pwn')
	content = content.replace('!', '!!!!!!!!!11111')
...
if __name__ == '__main__':
	...
	print '\"Filters\\Http_Internet-Example.py\" Loaded.'
